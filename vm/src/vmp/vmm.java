...
public class vmm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/food/shin.png"))); // NOI18N
    ...
    private void purchaseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_purchaseBtnActionPerformed
        ...
        if(tteokRB.isSelected()){
            money = (money - 89);
        }else if(onigiriRB.isSelected()){
            money = (money - 59);
        }else if(milkbreadRB.isSelected()){
            money = (money - 69);
        }else if(chramenRB.isSelected()){
            money = (money - 89);
        }else if(spramenRB.isSelected()){
            money = (money - 79);
        }else if(kimchiRB.isSelected()){
            money = (money - 85);
        }else if(milkisRB.isSelected()){
            money = (money - 39);
        }else if(bananamRB.isSelected()){
            money = (money - 29);
            ...
            changeTF.setText(Integer.toString((int) money));
        }
